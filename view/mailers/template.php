...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <style type="text/css">
      ...
      table[id=bodyTable] {width:100%!important;
      margin:auto;
      ...
      table[class=flexibleContainerCellDivider] {padding-bottom:0 !important;
      ...
      .nestedContainer{background-color:#F8F8F8;
       border:1px solid #CCCCCC;
     }
      .emailButton{background-color:#205478;
       border-collapse:separate;
     }
      .buttonContent{color:#FFFFFF;
       font-family:Helvetica;
       font-size:18px;
       font-weight:bold;
       line-height:100%;
      ...
      .buttonContent a{color:#FFFFFF;
       display:block;
       text-decoration:none!important;
       border:0!important;
     }
      .emailCalendar{background-color:#FFFFFF;
       border:1px solid #CCCCCC;
     }
      .emailCalendarMonth{background-color:#205478;
       color:#FFFFFF;
